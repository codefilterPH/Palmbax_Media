    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_thank_you_text', wagtail.fields.RichTextField(blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='booking.bookingpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
